      ...
      <div ref={domNode} className="">
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 lg:w-10/12">
            <div className="relative z-20 h-[300px] overflow-hidden  md:h-[450px]">
              ...
              >
                <a
                  ...
                  className="absolute z-20 flex h-20 w-20 items-center justify-center rounded-full bg-[#FF781D] text-primary dark:bg-dark-2 dark:text-white md:h-[100px] md:w-[100px]"
                >
      ...
      {videoOpen && (
        <div className="fixed left-0 top-0 z-50 flex h-screen w-full items-center justify-center bg-black bg-opacity-70">
          ...
          <button
            ...
            className="absolute right-5 top-5 flex h-12 w-12 cursor-pointer items-center justify-center text-body-color hover:bg-black"
          >
