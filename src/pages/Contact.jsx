  ...
  return (
    <div>
      ...
      <section className="mb-32">
        <div id="map" className="relative h-[680px] overflow-hidden bg-cover bg-[50%] bg-no-repeat px-4">
            ...
            <div className="flex flex-wrap">
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                <form>
                  ...
                  <button
                    type="submit"
                    className="bg-primary hover:bg-opacity-90 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition-all duration-200 ease-linear"
                  >
                    Submit
                  </button>
                </form>
              ...
              <div className="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
                <div className="flex flex-wrap">
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="inline-block rounded-md bg-[#FF781D] p-4 text-primary">
